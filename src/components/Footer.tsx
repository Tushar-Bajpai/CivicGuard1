        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex items-center gap-4 text-[#FAFFF3]/50 font-mono text-[9px]">
              <a href="https://github.com/Tushar-Bajpai/CivicGuard1" target="_blank" rel="noopener noreferrer" className="hover:text-[#C0F53D] transition-colors duration-200 flex items-center gap-2" id="link-github" aria-label="GitHub Repository"><Github className="w-4 h-4" /></a>
